...
PERCONA_SHARED=Percona-Server-shared-56-5.6.21-rel69.0.el6.x86_64
...
PERCONA_CLIENT=Percona-Server-client-56-5.6.21-rel69.0.el6.x86_64
...
PERCONA_SERVER=Percona-Server-server-56-5.6.21-rel69.0.el6.x86_64
